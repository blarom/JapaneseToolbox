...
public class SearchByRadicalFragment extends Fragment {
...
//        Log.i("Diagnosis Time","Loaded RadicalsDatabase.");
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View fragmentView = inflater.inflate(R.layout.fragment_search_by_radical, container, false);
    ...
    @Override public void onStart() {
        ...
        getExtras();
        if (!TextUtils.isEmpty(mInputQuery)) getKanjiFromRadicals(mInputQuery);
    }
