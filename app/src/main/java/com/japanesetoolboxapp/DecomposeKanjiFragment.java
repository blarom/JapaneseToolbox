...
public class DecomposeKanjiFragment extends Fragment {
    ...
    // Fragment Lifecycle Functions
        ...
        @Override public void onStart() {
            ...
            if (!outputFromInputQueryFragment.equals("")) { getDecomposition(outputFromInputQueryFragment, 0);}
        }
    ...
    // Functionality Functions
        ...
        public List<String> KanjiDictCharacteristicsFinder(String word) {
            ...
            String concatenated_input = SharedMethods.SpecialConcatenator(word);
